Всі потрібні для роботи бібліотеки є на початку коду.

База даних не зберігається єдиним SQL файлом (особливості роботи у PostgreSQL), тому я надам вам запити для її створення у вашій СУБД
